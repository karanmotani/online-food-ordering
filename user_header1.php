    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            <div class="navbar-header page-scroll">
				...
				<img src="img\spoon-and-fork.png" alt="eAt It Or BeAt It!" width="45" height="43"></a> -->
	        ...
	        <div class="row">
                   ...
                   <div class="intro-text">
						...
						<form method="POST" name="search_form" action="search_admin.php#portfolio" id="search_form">
                            ...
                            <!-- <div class="col-lg-2 col-lg-offset-2" style="height:35px;padding:5px;"> -->
                                <!-- <select name="search_food1" style="width: 125px;font-size: 15px;color: black;">
                            ...
                            <div class="form-group col-xs-1">
                                 <button type="submit" class="btn btn-success btn-lg" style='display: inline;height:35px;width:130px;font-size:1.2em;padding:0 20px;'>Search</button>
                            </div > -->
